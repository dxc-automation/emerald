...
var backHomeLink='';
if($('.single-project-menu').length > 0){
    backHomeLink = '../../';
}
let mobileMenuHTML = `
       <div  style="position: fixed;top: 0;z-index: 59;height: 100%;background: white;width: 100%;">
           <div style="position: relative;top: 50%; transform: translateY(-50%) translateY(-54px);">
               <ul class="mobileMenuContainer" style="font-family: SFProText-Light;font-size: 48px;text-align: center;line-height: 78px;">
                   <li onclick="location.href=backHomeLink+'index.html#projects'">Projects</li>
                   <li onclick="location.href=backHomeLink+'about.html'">About</li>
                   <li onclick="location.href=backHomeLink+'contact.html'">Contact</li>

               </ul>
            </div>
            <div class="footerMobileMenuContainer" style="position: absolute;bottom: 20px;width: 100%;">
                   <div class="contact-mobile-menu">
                        <div onclick="location.href='mailto:info@pausedesign.ca'" class="contact-item">info@pausedesign.ca</div>
                        <div class="contact-item"><a class="reset-link" href="tel:+14378865526">437 886 5526</a></div>
                    </div>
                    <div class="footer-wrap" style="padding-bottom: 40px;padding-top: 20px;position: relative;bottom: 0;text-align: center;">
                        <div class="footer">
                            <div class="footer-item link-item">
                                <a class="dropLink" target="_blank" href="https://www.instagram.com/PauseDesignInc/">instagram</a>
                            </div>
                            <div class="footer-item center link-item">
                                <a class="dropLink" target="_blank" href="https://www.twitter.com/PauseDesignInc/">twitter</a>
                            </div>
                            <div class="footer-item link-item">
                                <a class="dropLink" target="_blank" href="https://www.pinterest.ca/pausedesigninc/">pinterest</a>
                            </div>
                        </div>
                    </div>
            </div>
...
function disableHomePage() {
    ...
    if ($('.js-home-page').hasClass('disabled-by-projects') === false) {
        ...
        setTimeout(function () {
            $('.page.disabledScroll').removeAttr("style").removeClass('disabledScroll');
            activateProjects();
        }, 900);
    }
...
function enableHomePage() {
    ...
    if ($('.js-home-page').hasClass('disabled-by-projects') === true) {
        ...
        $('.page').removeClass('projects-pager').addClass('disabledScroll');
        deactivateProjects();
...
$(function () {
    ...
    if($('.projects-pager').length > 0){
        $('.projects-pager').removeAttr('style');
    }
})
...
$('.row-last--vertical-image').mouseenter(() => {
    $('#row-last--vertical-tile').addClass('hover');
});

$('.row-last--vertical-image').mouseleave(() => {
    $('#row-last--vertical-tile').removeClass('hover');
});
